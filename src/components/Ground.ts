...
export class GroundWalls{  //need to separate walls from ground class
    posX : number;
    posY : number;
    width : number;
    height: number;
    ...
    draw(level : number){
        this.ctx.beginPath();
        // this.ctx.drawImage(this.groundImg, 0, 0 , WALL_WIDTH,CANVAS_DIMENSIONS.CANVAS_HEIGHT );
        // this.ctx.drawImage(this.groundImg, CANVAS_DIMENSIONS.CANVAS_WIDTH-WALL_WIDTH, 0 , WALL_WIDTH,CANVAS_DIMENSIONS.CANVAS_HEIGHT );
        this.ctx.drawImage(this.groundImg, this.posX, this.posY, this.width, this.height);
        this.ctx.closePath();
        this.ctx.beginPath();
        this.ctx.closePath();
        this.drawTexts("Player 1",WALL_WIDTH, CANVAS_DIMENSIONS.CANVAS_HEIGHT-10);
        this.drawTexts("Level", (CANVAS_DIMENSIONS.CANVAS_WIDTH-WALL_WIDTH)/2, CANVAS_DIMENSIONS.CANVAS_HEIGHT-50);
        this.drawTexts("Player 2",CANVAS_DIMENSIONS.CANVAS_WIDTH-WALL_WIDTH-100, CANVAS_DIMENSIONS.CANVAS_HEIGHT-10);
        this.drawTexts(level.toString(),(CANVAS_DIMENSIONS.CANVAS_WIDTH-WALL_WIDTH)/2+25, CANVAS_DIMENSIONS.CANVAS_HEIGHT-10);
